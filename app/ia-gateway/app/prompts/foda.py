...
def construir_prompt_foda(contexto: ContextoNegocio) -> str:
    return (
        ...
        "propuestas encajen con cómo el negocio quiere sonar, y usa los competidores como "
        "referencia de qué funciona en la zona — no para copiarlos. Da entre 2 y 3 puntos "
        "concretos y accionables por categoría, en español, sin tecnicismos.\n\n"
